...
class nonformalcontroller extends Controller
{
    ...
    {
        $nonformall = nonformal::all();
        return view('nonformal.index', compact('nonformall'));
    }
...
//pengalaman
       ...
       'penghargaan'=>$request->penghargaan
          ...
          return redirect()->route('nonformal.index')
          ->with('success', 'ok');
      }
    }
    ...
    {
        $nonformall =nonformal::oldest('id_pelamar')->simplepaginate(1);
        return view('pelamar.detail',compact('nonformal'));
    }
    ...
    {
        $nonformall = nonformal::where('id_pelamar', $id_pelamar)->first();
        return view('nonformal.edit', compact('nonformall'));
    }
...
//pengalaman
       ...
       'penghargaan'=>'',
        ...
        $nonformall = nonformal::where('id_pelamar', $id_pelamar);


        $nonformall->update($request->except('_token','_method'));
        return redirect()->route('nonformall.index')
