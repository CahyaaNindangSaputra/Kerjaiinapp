...
class ListingController extends Controller
{
    ...
    public function show(Listing $listing, Request $request)
    {
        ...
        // $listing =pelamar::oldest('id_pelamar')->simplepaginate(1);
        // return view('listings.detail',compact('pelamarr'));
    ...
    public function store(Request $request)
    {
        ...
        // try {
        //     $amount = 100; // $99.00 USD in cents
        //     if ($request->filled('is_highlighted')) {
        //         $amount += 100;
        //     }

        //     $listing->charge($amount, $request->payment_method_id);
