...
class prestasicontroller extends Controller
{
    ...
    {
        $prestasii = prestasi::all();
        return view('prestasi.index', compact('prestasii'));
    }
...
//pengalaman
    ...
    {
        $prestasii =prestasi::oldest('id_pelamar')->simplepaginate(1);
        return view('prestasi.detail',compact('prestasii'));
    }
    ...
    {
        $prestasii = prestasi::where('id_pelamar', $id_pelamar)->first();
        return view('prestasi.edit', compact('prestasii'));
    }
...
//pengalaman
       ...
       'penghargaan'=>'',
        ...
        $prestasii = prestasi::where('id_pelamar', $id_pelamar);


        $prestasii->update($request->except('_token','_method'));
        return redirect()->route('prestasii.index')
