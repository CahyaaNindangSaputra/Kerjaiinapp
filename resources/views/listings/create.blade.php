        ...
        <div class="w-full md:w-1/2 py-24 mx-auto">
            <div class="mb-4">
                <h2 class="text-2xl font-medium text-gray-900 title-font">
                    Buat Postingan Loker baru (Rp.10.000)
                </h2>
            </div>
            @if($errors->any())
            ...
            >
                ...
                @endguest
                <div class="mb-4 mx-2">
                    <x-label for="title" value=" Title Pekerjaan" />
                    <x-input
                        id="title"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="company" value="Nama Perusahaan" />
                    <x-input
                        id="company"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="location" value="Lokasi (e.g. Indonesia)" />
                    <x-input
                        id="location"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="apply_link" value="Link Apply Kerja" />
                    <x-input
                        id="apply_link"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="tags" value="Tipe Bekerja" />
                    <x-input
                        id="tags"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="content" value="Deskripsi Pekerjaan" />
                    <textarea
                        id="content"
                        rows="8"
                ...
                <div class="mb-4 mx-2">
                    <label for="is_highlighted" class="inline-flex items-center font-medium text-sm text-gray-700">
                        ...
                        {{-- <span class="ml-2">Highlight this post (extra Rp.20.000)</span> --}}
                    </label>
                </div>
                <div class="mb-6 mx-2">
